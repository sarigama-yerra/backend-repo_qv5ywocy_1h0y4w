...
app = FastAPI(title="Van der Linde Catering API")
...
@app.get("/")
def read_root():
    return {"message": "Van der Linde API running"}
...
def submit_contact(payload: ContactRequest):
    try:
        ...
        # If database is not available, still acknowledge receipt (demo purposes)
